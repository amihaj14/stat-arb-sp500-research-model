...
CACHE_PATH = os.path.join(PACKAGE_DIR, "price_cache.csv")
MAX_CANDIDATE_PAIRS = 1000
CORRELATION_THRESHOLD = 0.92
START_DATE = "2018-01-02"

# Load the S&P 500 universe from the CSV file.
constituents_path = os.path.join(PACKAGE_DIR, "constituents.csv")
tickers_df = pd.read_csv(constituents_path)
